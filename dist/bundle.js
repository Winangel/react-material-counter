...
/***/ function(module, exports, __webpack_require__) {
	...
	// we import naturally react


	var store = (0, _redux.createStore)(_reducers.counters); // we import the provider from react-dedux
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var counters = exports.counters = function counters(state, action) {
	  switch (action.type) {
	    case 'INCREMENT':
	      return (0, _core.increment)(state, action.payload.id);
	    case 'DECREMENT':
	      return (0, _core.decrement)(state, action.payload.id);
	    default:
	      return state;
	  }
	};
...
/***/ function(module, exports) {
	...
	function increment(state, id) {
	  var new_state = Object.assign({}, state);
	  new_state.counters[id].count++;
	  return new_state;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CounterListContainer = __webpack_require__(183);

	var _CounterListContainer2 = _interopRequireDefault(_CounterListContainer);
	...
	var App = function App() {
	  _react2.default.createElement(
	    'div',
	    null,
	    _react2.default.createElement(_CounterListContainer2.default, null)
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CounterList = __webpack_require__(184);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    incrementCount: function incrementCount(id) {
	      dispatch((0, _actions.increment)(id));
	    },
	    decrementCount: function decrementCount(id) {
	      dispatch((0, _actions.decrement)(id));
	    }
	  };
	};
	...
	var CounterListContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_CounterList.CounterList);

	exports.default = CounterListContainer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CounterList = function CounterList(_ref) {
	  ...
	  var incrementCount = _ref.incrementCount;
	  var decrementCount = _ref.decrementCount;

	  return elements.map(function (element) {
	    return _react2.default.createElement(_Counter2.default, { title: element.title, count: element.count, increment: incrementCount, decrement: decrementCount });
	  });
	};
...
/***/ function(module, exports) {
	...
	var increment = exports.increment = function increment(id) {
	  return {
	    type: 'INCREMENT',
	    payload: {
	      id: id
	...
	var decrement = exports.decrement = function decrement(id) {
	  return {
	    type: 'DECREMENT',
	    payload: {
	      id: id
